    ...
    return (
        <Col>
            <Card style={{ border: 'none'}}>
                <CardBody>
                <CardTitle> <h4 className="text-secondary"><a href="https://github.com/cauld19/Sprint-Challenge-React-Wars" className="text-decoration-none">React Wars</a></h4> </CardTitle>
                <hr />
